...
insert into user (id, username, password, email, first_name, last_name, mobile, city, state, sex, profession, organization_information, enabled, role) values (8, 'makist', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'makist@gmail.com', 'Marija', 'Maric', '520-661-4444', 'Beograd', 'Srbija', 'Female', 'Web Dev', 'RTRK', true, 'Stuff');
...
insert into stuff(id, company_id) values (8, 1);

insert into registered_user (id, points, category, benefits) values (2, 0,'Redovan', 'Redovan');
insert into registered_user (id, points, category, benefits) values (3, 0,'Redovan', 'Redovan');
insert into registered_user (id, points, category, benefits) values (5, 0,'Redovan', 'Redovan');
...
values (1, '2024-01-22 09:10:00', 15, false, '2024-03-01 08:00:00', '2024-03-01 08:15:00', false, 3, 1, 1);
...
insert into appointment (id, date, duration, is_free, reservation_start, reservation_end, is_registered_user_come, registered_user_id, company_id, calendar_id, stuff_id)
values
    (2, '2024-01-27 09:00:00', 30, true, '2023-02-03 08:00:00', '2023-01-30 08:30:00', false, null, 1, 1, 8),
